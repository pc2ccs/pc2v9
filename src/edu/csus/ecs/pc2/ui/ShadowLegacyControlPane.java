...
import edu.csus.ecs.pc2.shadow.ShadowLegacyController;
...
// $HeadURL$
public class ShadowLegacyControlPane extends JPanePlugin {
    ...
    private ShadowLegacyController shadowController;
     ...
     * 
     */
    public ShadowLegacyControlPane(IInternalContest inContest, IInternalController inController) {
        super();
...
//        getWebServer().startWebServer(getContest(), getController(), properties);
        ...
        if (shadowCheckboxEnabled && shadowDataComplete) {
            shadowController = new ShadowLegacyController(this.getContest(),this.getController()) ;
    ...
    private void handleStartFailure() {
        ...
        edu.csus.ecs.pc2.shadow.ShadowLegacyController.SHADOW_CONTROLLER_STATUS failureStatus = shadowController.getStatus();
