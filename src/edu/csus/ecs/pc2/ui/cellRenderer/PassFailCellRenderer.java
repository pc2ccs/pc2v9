 ...
 * <p>
 * If the received Object is a String then the cell is rendered based on the text of the string: "pass" renders as
 * a green/pass while "fail" renders as a red/fail.  The check for the value of the String is not case-sensitive.
 * <P>
 ...
 *
 * If the value passed to the {@link #setValue(Object)} method is any of the above-listed types then 
