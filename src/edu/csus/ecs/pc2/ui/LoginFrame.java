...
public class LoginFrame extends JFrame implements ILoginUI {
    ...
    private void initialize() {
        this.setSize(new java.awt.Dimension(INITIAL_FRAME_WIDTH,600));
        this.setPreferredSize(new java.awt.Dimension(INITIAL_FRAME_WIDTH,600));
        this.setMinimumSize(new java.awt.Dimension(INITIAL_FRAME_WIDTH,600));
...
//           Border compound = BorderFactory.createCompoundBorder(orangeline, empty);
    ...
    private JPanel getNorthPanel() {
        if (northPanel == null) {
            ...
            //TODO: delete border around spacer
//            spacerLabel.setBorder (new LineBorder(Color.CYAN));
    ...
    private JPanel getTitlePanel() {
        ...
        //TODO: delete border around title panel
//        titlePanel.setBorder(new LineBorder(Color.MAGENTA));
        ...
        //TODO: delete border around top label
//        mainTitleTopLabel.setBorder(new LineBorder(Color.RED));
        ...
        //TODO: delete border around bottom label
