 ...
 *
 */
public class ShadowLegacyCompareRunsFrame extends JFrame {

    private static final long serialVersionUID = 1L;
    
    public ShadowLegacyCompareRunsFrame(ShadowLegacyController shadowController) {
        setMinimumSize(new Dimension(750, 900));
        Dimension size = new Dimension(750,750);
        this.setPreferredSize(size);
//        this.setMinimumSize(size);
        
        ShadowLegacyCompareRunsPane runsPane = new ShadowLegacyCompareRunsPane(shadowController);
