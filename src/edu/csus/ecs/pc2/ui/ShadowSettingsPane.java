...
public class ShadowSettingsPane extends JPanel {
    ...
    private JCheckBox combineScoreboardsCheckbox;
    ...
    public ShadowSettingsPane() {
        ...
        this.add(getCombineScoreboardsCheckbox(), getCombineScoreboardsCheckboxConstraints());
...
//            c.anchor = GridBagConstraints.LINE_START; // CENTER is the default
    ...
    private GridBagConstraints getCombineScoreboardsCheckboxConstraints() {
        GridBagConstraints c = new GridBagConstraints();
        //row & col at upper left of component
            c.gridx = 0;
            c.gridy = 1;
...
//            c.anchor = GridBagConstraints.LINE_START; // CENTER is the default
    ...
    public JCheckBox getCombineScoreboardsCheckbox() {
        if(combineScoreboardsCheckbox == null) {

            combineScoreboardsCheckbox = new JCheckBox("Combine scoreboard mode", false);
            combineScoreboardsCheckbox.setToolTipText("Combined scoreboard mode allows PC2 to fetch submissions from a remote Contest Control System "
                    + " and use the remote's judgments for the submissions.  This has the effect of adding "
                    + " these runs to the system and making them part of the scoreboard.");
            combineScoreboardsCheckbox.setMnemonic(KeyEvent.VK_C);

        }
        return combineScoreboardsCheckbox;
    }
