...
public class ClickMeFrame extends JFrame implements ActionListener, ComponentListener, MouseListener, MouseMotionListener, WindowListener {
    ...
    /**
     * Handles MouseDragged events by checking if the Drag was on the Chase Panel and if so delegating handling to {@link ClickMeFrame#clickMeChasePanelMouseDragged(e)}.
     * 
     * @param e
