...
/**
 * Standings Pane based on NewScoringAlgorithm
 * 
 * @author Douglas A. Lane <pc2@ecs.csus.edu>
 */
public class NSAStandingsPane extends JPanePlugin {
...
//        Object[] cols = { "Rank", "Name", "Solved", "Points" };
    ...
    protected void parseAndDisplay() {
        ...
        try {
            ...
            xmlString = scoringAlgorithm.getStandings(getContest(), properties, getController().getLog());
