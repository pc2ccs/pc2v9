 ...
 *
 * TODO: Remove this class - it is not refereneced by any module. -- JB
...
public class TeamsJSON {
    ...
    public String createJSON(IInternalContest contest) throws IllegalContestState {
        ...
        for (Account account : accounts) {
            ...
            if (account.getPrimaryGroupId() != null && groupMap.containsKey(account.getPrimaryGroupId())) {
                groupName = groupMap.get(account.getPrimaryGroupId());
            }
