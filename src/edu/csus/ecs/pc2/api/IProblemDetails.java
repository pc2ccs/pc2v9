...
/**
 * This interface describes the PC<sup>2</sup> API view of the a client's per-problem score detail
 * <P>
 * An {@link IProblemDetails} object contains information about a client's problem scoring details for one particular problem.
 *
 * <p>
