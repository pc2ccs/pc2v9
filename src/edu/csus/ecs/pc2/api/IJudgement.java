 ...
 * 
 * A <I>Judgement</i> represents one of the judgement values which
 * the Contest Administrator has configured into the contest settings and from which
 * a Judge may choose when assigning a result to any particular submitted run.
 *  
 * 
 * <p>
