...
public class CustomJavaPC2InterfaceValidator {
    ...
    private void usage() {
        System.out.println("Usage: java CustomJavaPC2InterfaceValidator [options] <inputfile name> <outputfile name> <answerfile name> <resultfile name> <-pc2> [pc2_option] icflag");
        System.out.println();
