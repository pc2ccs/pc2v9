...
{
	public final static String ID_TAG_NAME = "id";

	public final static String JUDGED_TAG_NAME = "judged";

	public final static String LANGUAGE_TAG_NAME = "language";

	public final static String PENALTY_TAG_NAME = "penalty";

	public final static String PROBLEM_TAG_NAME = "problem";

	public final static String RESULT_TAG_NAME = "result";

	public final static String SOLVED_TAG_NAME = "solved";

	public final static String STATUS_TAG_NAME = "status";

	public final static String TEAM_TAG_NAME = "team";

	public final static String TIME_TAG_NAME = "time";

	public final static String TIMESTAMP_TAG_NAME = "timestamp";
