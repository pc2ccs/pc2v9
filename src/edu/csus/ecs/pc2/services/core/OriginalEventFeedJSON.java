...
/**
 * Original as of 12/30/2019 Event feed information in the CLICS JSON format.
 * 
 * @author Douglas A. Lane, PC^2 Team, pc2@ecs.csus.edu
 */
public class OriginalEventFeedJSON extends JSONUtilities {
    /**
     * 
     */
    public OriginalEventFeedJSON(IInternalContest contest) {
        super();
