...
public class TeamService {
    ...
    /**
     * This method returns a String representation of the current contest teams in JSON format.
     * The returned string is a JSON array with one team description per array element.
     * 
