...
//        }
    ...
    public void addProblem(Problem problem) {
        ...
        if (me != null) {
            ...
            if (account != null && account.isTeam() && account.getGroupIds() != null) {
                // If is a team and has been assigned one or more groups.
                boolean canSeeProblem = false;
...
//            }
    ...
    public ContestTime getContestTime(ElementId elementId) {
        return contestTimeList.get(elementId);
    }
    ...
    public Account getAccount(ClientId inClientId) {
        return accountList.getAccount(inClientId);
    }
    ...
    public ClientSettings getClientSettings() {
        return clientSettingsList.get(getClientId());
    }

    @Override
    public ClientSettings getClientSettings(ClientId clientId) {
        return clientSettingsList.get(clientId);
    }
...
// JB Regionals26        this.contestInformation.setScoreboardType("score" /*stype.getType()*/);
