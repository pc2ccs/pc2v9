...
//          }
     ...
     * teams2.tsv is preferred over teams.tsv since it has groups in it.
     * If teams.tsv is specified, the existence of teams2.tsv is
     * checked.  If found, it replaces teams.tsv.
     * @param filename - one of "/path-to/teams.tsv", "/path-to/teams2.tsv" or "/path-to/groups.tsv"
    ...
    protected boolean checkFiles(String filename) throws Exception {
        ...
        File file = new File(teamsFilename);
