...
public class AccountService implements Feature {
    ...
    /**
     * This method returns a representation of the current model accounts in JSON format
     * The returned value is a JSON array with one account description per array element.
     *
     * @param sc user information
     * @param contestId the contest for which the accounts are requested
     * @return a {@link Response} object containing the model accounts in JSON form
     */
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    ...
    /**
     * Return response to the request for information about a specific accountid in a specific contestid
     *
     * @param sc user information
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    @Path("{accountId}/")
    public Response getAccount(@Context SecurityContext sc, @PathParam("contestId") String contestId, @PathParam("accountId") String accountId) {
