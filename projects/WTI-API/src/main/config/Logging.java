 ...
 * by invoking method {@link #getLogger()}, which returns a singleton {@link Logging} object.
...
public class Logging {
	...
	static private Logging logger = null;
	 ...
	 * {@link Logging#enableConsoleLogging} to turn logging on.
	...
	/**
	 * Returns a singleton instance of the {@link Logging} class. The returned Logging object uses
	 * an underlying {@link java.util.logging.Logger} to do the actual logging.  
	 *  
	 * @return a {@link Logging} object on which logging operations can be invoked
	 */
