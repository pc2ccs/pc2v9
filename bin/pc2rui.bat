...
rem Purpose: start the report UI module
...
javaw -Djdk.crypto.KeyAgreement.legacyKDF=true -Xms64M -Xmx768M -cp "%libdir%\*" edu.csus.ecs.pc2.Starter --ui edu.csus.ecs.pc2.ui.admin.ReportsView %1 %2 %3 %4 %5 %6 %7 %8 %9
