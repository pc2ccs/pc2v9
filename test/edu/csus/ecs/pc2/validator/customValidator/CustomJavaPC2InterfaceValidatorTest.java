...
public class CustomJavaPC2InterfaceValidatorTest extends AbstractTestCase {
    ...
    private static final String DATA_DIR_PATH = "CustomJavaPC2InterfaceValidatorTest";
...
//    unused private static final String OUT_DIR_PATH = "testing" + File.separator + "validator" + File.separator + "output";
    ...
    public void testYesJudgement() throws Exception {
        ...
        runExecutableTest(run, runFiles, true, PC2Validator.JUDGEMENT_YES);
    ...
    public void testNoJudgement() throws Exception {
        ...
        contest.setClientId(getLastAccount(Type.JUDGE).getClientId());
        runExecutableTest(run, runFiles, false, PC2Validator.JUDGEMENT_NO_WRONG_ANSWER);
    }
    ...
    protected void setupValidator(Problem problem, ProblemDataFiles problemDataFiles) throws FileNotFoundException {
        ...
        String validatorCommand = Constants.DEFAULT_PC2_VALIDATOR_COMMAND + " -pc2 1 true";
        ...
        assertTrue("Expecting problem validator command line to be PC2 Command Line, but failed", 
