...
public class ContestTestFrame extends JFrame {
    ...
    protected class RunListener implements IRunEventListener {
        ...
        public void runAdded(IRun run) {
            System.out.println("Run added Site " + run.getSiteNumber() + " Run " + run.getNumber() + " from "
                    + run.getSubmitterTeam().getTitle() + " at " + run.getSubmissionTime());
        }
    ...
    protected void getRunsTest() {
        ...
        for (IRun run : contest.getRuns()) {
            ...
            System.out.print(" @ " + run.getSubmissionTime() + " by " + run.getSubmitterTeam().getShortName());
            System.out.print(" problem: " + run.getProblem().getTitle());
            System.out.print(" in " + run.getLanguage().getTitle());
    ...
    protected void attachToContest() {
        ...
        try {
            ...
            setTitle("Contest " + contest.getClient().getTitle() + " " + contest.getSiteTitle());
    ...
    protected void getTeamsTest() {
        ...
        for (ITeam team : contest.getTeams()) {
            System.out.println(team.getShortName() + " title: " + team.getTitle() + " group: " + team.getGroup().getTitle());
        }
