...
//        System.out.println("xml  = "+xml);
    ...
    public String[] getAllEventFeedTagNames() {
        String[] tagnames = { //
        ResolverEventFeedXML.CONTEST_TAG, ResolverEventFeedXML.INFO_TAG, ResolverEventFeedXML.REGION_TAG, ResolverEventFeedXML.PROBLEM_TAG, ResolverEventFeedXML.LANGUAGE_TAG,
                ResolverEventFeedXML.TEAM_TAG, ResolverEventFeedXML.CLARIFICATION_TAG, ResolverEventFeedXML.TESTCASE_TAG, ResolverEventFeedXML.RUN_TAG, ResolverEventFeedXML.JUDGEMENT_TAG,
                ResolverEventFeedXML.FINALIZE_TAG, ResolverEventFeedXML.JUDGEMENT_RECORD_TAG
        //
        };
        return tagnames;
    }
    ...
    private void validateUsingSchema(String xml) throws Exception {
        ...
        String outfilename = testDir + File.separator + "testing.ef.xml";
        writeFileContents(outfilename, contents);
