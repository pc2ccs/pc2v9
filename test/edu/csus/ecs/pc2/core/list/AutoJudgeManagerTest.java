 ...
 */
public class AutoJudgeManagerTest extends AbstractTestCase {
    ...
    public void testaddAvailableAutoJudge() throws Exception {
        ...
        AutoJudgeManager handler = new AutoJudgeManager();
...
//        }
        ...
        assertEquals("Runs in list ", 3, handler.getAvailableAJRuns().size());
//        AutoJudgeManager.dump("debug 22 junit", System.out, contest);

        Run run = handler.findRunToAutoJudge(contest, autojudge);
        assertNotNull(run);

        System.out.println("debug 22 found run " + run);
    ...
    public void testUsingContest() throws Exception {
