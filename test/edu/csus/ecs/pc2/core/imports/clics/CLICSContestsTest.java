...
//        String json = "{\"type\": \"problems\", \"id\": \"542cc6e2-104a-49bc-9fea-04752f9af5ad\", \"op\": \"delete\", \"data\": null }";
        ...
        CLICSEventFeedEvent eventFeedEntry = mapper.readValue(json, CLICSEventFeedEvent.class);
...
//        assertEquals("penalty_time", penaltyTime, clicsContests.getPenalty_time());
        ...
        assertEquals("scoreboard_freeze_duration", info.getFreezeTime(), ContestCompareModel.clipMs(clicsContests.getScoreboard_freeze_duration()));
