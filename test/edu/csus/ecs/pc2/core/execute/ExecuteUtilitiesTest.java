...
//        dumpArray(contest.getLanguages());
    ...
    public void testSubstituteStringTest() throws Exception {
        ...
        // input;expected
                ...
                Constants.DEFAULT_PC2_VALIDATOR_COMMAND + ";edu.csus.ecs.pc2.validator.Validator sumit.dat teams.output.txt sumit.ans "+resultsFileName+" ", // 
                "{:ansfile};sumit.ans", // 
                "{:basename};Sumit", // 
                "{:executetime};45321", // 
                "{:exitvalue};45", // 
                ...
                "{:teamid};1", // 
                "{:timelimit};30", // 
                "{:validator};edu.csus.ecs.pc2.validator.Validator", // 
