...
public class NewScoringAlgorithmTestLong extends TestCase {
     ...
     * @throws IOException
     */
    public void createJudgedRun(IInternalContest contest, int judgementIndex, boolean solved) throws IOException,
...
//            algorithm = new DefaultScoringAlgorithm();
    ...
    public void testScoreboardCaseOneA() {
        ...
        String[] runsData = { "2,8,C,1,No", "15,8,D,1,Yes", "23,8,D,1,No", "29,8,D,1,No", "43,8,C,1,No", "44,8,A,1,Yes",
                "52,8,C,1,Yes", "65,8,B,2,Yes", };

        // Rank TeamId Solved Penalty

        String[] rankData = { "1,team8,4,45", "2,team1,0,0", "2,team2,0,0", "2,team3,0,0", "2,team4,0,0", "2,team5,0,0",
                "2,team6,0,0", "2,team7,0,0", };
    ...
    public void testNoBeforeYesSameElapsed() {
        ...
        // Rank TeamId Solved Penalty
        String[] rankData = { "1,team8,1,12", "2,team4,1,15", "3,team2,1,22", "4,team1,0,0", "4,team3,0,0", "4,team5,0,0",
                "4,team6,0,0", "4,team7,0,0", };
    ...
    public void testScoreboardCaseTwo() {
        ...
        /**
         * Case 2 tests when all no runs are counted, the current SA does not support this scoring method. The commented rankData is
         * the proper results
         */
    ...
    public void testScoreboardCaseThree() {
        ...
        /**
         * Case 3 tests when all runs are counted, the current SA does not support this scoring method. The commented rankData is
         * the proper results
         */
    ...
    public void testScoreboardCaseFour() {
        ...
        /**
         * Case 4 tests when all runs are counted, the current SA does not support this scoring method. The commented rankData is
         * the proper results
         */
    ...
    public void testScoreboard55() {
        ...
        String[] runsData = { "1,16,B,1,No", "2,8,C,1,No", "3,5,B,1,No", "4,4,C,1,No", "5,4,D,1,No", "6,3,A,1,No", "7,1,A,1,No",
                "8,6,B,1,New", "9,18,A,1,No", "10,6,A,1,No", "11,21,D,1,Yes", "12,6,D,1,No", "13,12,A,1,Yes", "14,13,A,1,No",
                "15,8,D,1,Yes", "16,3,B,1,No", "17,3,A,1,No", "18,16,C,1,No", "19,20,D,1,Yes", "20,12,B,1,No", "21,14,A,1,No",
                "22,15,C,1,No", "23,8,D,1,No", "24,13,D,1,No", "25,21,A,1,No", "26,18,D,1,Yes", "27,6,C,1,No", "28,20,B,1,Yes",
                "29,8,D,1,No", "30,19,B,1,No", "31,22,C,1,No", "32,7,A,1,No", "33,7,A,1,No", "34,4,D,1,New", "35,18,B,1,No",
                "36,4,D,1,Yes", "37,19,C,1,No", "38,2,B,1,No", "39,15,C,1,No", "40,12,B,1,No", "41,10,D,1,Yes", "42,22,A,1,No",
                "43,8,C,1,No", "44,8,A,1,Yes", "45,18,D,1,No", "46,13,C,1,No", "47,7,D,1,No", "48,7,C,1,New", "49,5,C,1,No",
                "50,7,B,1,New", "51,21,B,1,No", "52,8,D,1,Yes", "53,16,A,1,No", "54,10,A,1,No", "55,22,B,1,No", "56,18,C,1,No",
                "57,5,D,2,Yes", "58,10,C,2,No", "59,9,C,2,Yes", "60,5,D,2,Yes", "61,12,D,2,No", "62,10,C,2,No", "63,3,B,2,Yes",
                "64,21,C,2,No", "65,8,B,2,Yes", "66,19,B,2,Yes", "67,18,A,2,No", "68,12,D,2,Yes", "69,5,B,2,Yes", "70,2,A,2,No",
                "71,21,D,2,No", "72,12,D,2,No", "73,18,C,2,No", "74,14,D,2,Yes", "75,2,A,2,No", "76,20,D,2,No", "77,7,C,2,No",
                "78,14,D,2,No", "79,15,A,2,No", "80,16,B,2,No", "81,2,C,2,No", "82,2,C,2,No", "83,22,A,2,No", "84,21,D,2,Yes",
                "85,2,C,2,No", "86,10,C,2,No", "87,17,C,2,No", "88,7,A,2,New", "89,20,B,2,No", "90,12,C,2,No" };

        // Rank TeamId Solved Penalty

        String[] rankData = { "1,team8,3,4", "2,team20,2,2", "3,team12,2,23", "4,team5,2,24", "5,team10,1,1", "5,team18,1,1",
                "5,team21,1,1", "8,team9,1,2", "8,team14,1,2", "10,team3,1,22", "10,team19,1,22", "12,team4,1,41", "13,team1,0,0",
                "13,team2,0,0", "13,team6,0,0", "13,team7,0,0", "13,team11,0,0", "13,team13,0,0", "13,team15,0,0", "13,team16,0,0",
                "13,team17,0,0", "13,team22,0,0", };
    ...
    public void testScoreboard55Groups() {
        ...
        String[] groupRankData = { "1,team8,3,4", // Site 8 1
                "1,team20,2,2", //  Site 5 1
                "1,team12,2,23", // Site 4 1
                "1,team5,2,24", //  Site 10 1
                "2,team10,1,1", //  Site 10 2
                "1,team18,1,1", // Site 2 1
                "1,team21,1,1", // Site 9 1
                "2,team9,1,2", //  Site 5 2
                "1,team14,1,2", // Site 3 1
                "1,team3,1,22", // Site 6 1
                "2,team19,1,22", // Site 9 2
                "3,team4,1,41", // Site 9 3
                "4,team1,0,0", // Site 9 4
                "2,team2,0,0", // Site 2 2
                "2,team6,0,0", // Site 2 2
                "2,team7,0,0", // Site 2 2
                "2,team11,0,0", // Site 2 2
                "2,team13,0,0", // Site 2 2
                "2,team15,0,0", // Site 2 2
                "2,team16,0,0", // Site 2 2
                "2,team17,0,0", // Site 2 2
                "4,team22,0,0", // Site 9 5
        };
    ...
    private void scoreboardTest(int numTeams, String[] runsDataList, String[] rankDataList, boolean respectSendTo,
            Properties scoreProps, String [] groupAssignments, boolean testGroupRanks) {
    ...
    private void confirmRanks(InternalContest contest, String[] rankData, Properties scoreProps, boolean compareGroupRanks) {
        ...
        if (debugMode) {
            ...
            for (Run run : runs) {
                System.out.println("Run " + run.getNumber() + " time=" + run.getElapsedMins() + " " + run.getSubmitter().getName()
                        + " solved=" + run.isSolved());
            }
            System.out.flush();
        ...
        for (int i = 0; i < list.getLength(); i++) {
            ...
            if (name.equals("teamStanding")) {
                ...
                if (debugMode) {
                    System.out.println("SA rank=" + standingsRow[0] + " solved=" + standingsRow[2] + " points=" + standingsRow[3]
                            + " name=" + standingsRow[1]);
     ...
     * 
     * @param node
     * @param fetchGroupRank if true, fetch the group rank
