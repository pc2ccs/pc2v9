...
<xsl:template match="contestStandings">
    <HTML>
        <HEAD>
<TITLE>
Summary/Time - <xsl:value-of select="/contestStandings/standingsHeader/@title"/>
</TITLE>
        </HEAD>
        <BODY>
            <TABLE border="1">
...
<p>
Created by <A HREF="http://www.ecs.csus.edu/pc2">CSUS PC^2 <xsl:value-of select="/contestStandings/standingsHeader/@pc2version"/></A><br/>
